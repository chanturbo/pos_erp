...
PdfColor _typeColor(String t) {
  switch (t) {
    case 'IN':           return _kSuccess;
    case 'OUT':          return _kWarning;
    case 'ADJUST':       return const PdfColor.fromInt(0xFF1565C0);
    case 'TRANSFER_IN':
    case 'TRANSFER_OUT': return const PdfColor.fromInt(0xFF4A148C);
    case 'SALE':         return _kError;
...
class StockProductHistoryPdfBuilder {
        ...
        pw.Page(
          ...
          build: (ctx) => pw.Column(
            ...
            children: [
              ...
              pw.Spacer(),
              _buildFooter(companyName: companyName, ttfRegular: ttfRegular),
            ],
          ),
        ),
      );
    ...
    return pw.Table(
      ...
      children: [
        ...
        pw.TableRow(
          ...
          children: ['#', 'วันที่/เวลา', 'ประเภท', 'คลัง', 'จำนวน', 'อ้างอิง', 'หมายเหตุ']
              .map((h) => pw.Container(
        ...
        ...items.asMap().entries.map((e) {
          ...
          return pw.TableRow(children: [
            cell('${startNo + i}', ttfRegular,
                ...
                color: _kSub,
                bgColor: rowBg),
            cell(DateFormat('dd/MM/yy HH:mm').format(item.movementDate),
                ttfRegular, bgColor: rowBg),
            // ประเภท — plain text with mild color, no bg badge
            cell(_typeLabel(item.movementType), ttf,
                color: tColor, bgColor: rowBg),
            ...
            cell(item.referenceNo ?? '—', ttfRegular,
                color: _kSub, bgColor: rowBg),
            cell(item.remark ?? '—', ttfRegular,
                color: _kSub, bgColor: rowBg),
          ]);
        }),
      ],
  ...
  static pw.Widget _buildFooter({
    ...
    return pw.Container(
      ...
      child: pw.Text('$companyName — ประวัติสต๊อกสินค้า',
