...
class _PurchaseReturnFormPageState
  ...
  void _initControllers() {
    if (widget.returnDoc != null) {
      ...
      _returnNoController =
          TextEditingController(text: 'PRET${ts.toString().substring(8)}');
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: 8),
                Text(dateFmt.format(_returnDate),
                    style: TextStyle(
                        fontSize: 13,
        ...
        child: Center(
          child: Column(
            children: [
              ...
              Text('กรุณาเลือกซัพพลายเออร์ก่อน',
                  style: TextStyle(
                      fontSize: 13,
                      color: isDark
                          ? const Color(0xFF888888)
          ...
          children: [
            ...
            Text('฿${fmt.format(total)}',
                style: TextStyle(
                    ...
                    color:
                        isDark ? const Color(0xFFEF9A9A) : AppTheme.error)),
          ],
        ),
      ],
    );
    ...
    if (_isViewMode) {
      return Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          _ViewField(
              text: _reasonController.text.isEmpty
                  ? '-'
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(8),
                borderSide:
                    BorderSide(color: isDark ? const Color(0xFF3A3A3A) : AppTheme.border)),
  ...
  Future<void> _addItem() async {
    ...
    final result = await showDialog<PurchaseReturnItemModel>(
      ...
      builder: (ctx) => _ItemDialog(
          products: products, lineNo: _items.length + 1, isDark: isDark),
    );
...
class _SupplierSelectionDialog extends StatefulWidget {
  ...
  const _SupplierSelectionDialog(
      {required this.suppliers, required this.isDark});
...
class _ItemDialog extends StatefulWidget {
  ...
  const _ItemDialog(
      {required this.products, required this.lineNo, required this.isDark});
