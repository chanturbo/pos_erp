                ...
                child: Row(
                  children: [
                    ...
                    _PRFilterChip(
                      ...
                      onTap: () => setState(
                          () { _statusFilter = 'CONFIRMED'; _currentPage = 1; }),
                    ),
                  ],
                ),
              ),
        ...
        Expanded(
          child: ListView.builder(
            ...
            itemBuilder: (context, i) {
              ...
              final statusColor =
                  r.isConfirmed ? AppTheme.success : AppTheme.warning;
              return InkWell(
                onTap: () => _openForm(r),
                child: Container(
    ...
    final ok = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('ยืนยันใบคืนสินค้า ${r.returnNo}?',
                style: TextStyle(
                    fontSize: 14,
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 8),
                  const Expanded(
                    child: Text('ระบบจะลดสต๊อกสินค้าตามจำนวนที่คืน',
                        style:
  ...
  Future<void> _deleteReturn(PurchaseReturnModel r) async {
    ...
    final ok = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        shape:
            RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
        title: Text('ลบใบคืนสินค้า',
            style: TextStyle(
                fontSize: 16,
                fontWeight: FontWeight.w600,
                color: isDark ? Colors.white : Colors.black87)),
        content: Text('ต้องการลบใบคืนสินค้า ${r.returnNo} ใช่หรือไม่?',
            style: TextStyle(
                fontSize: 14,
                color: isDark ? Colors.white70 : AppTheme.textSub)),
        actions: [
...
class _PRCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final statusColor =
        returnDoc.isConfirmed ? AppTheme.success : AppTheme.warning;
    final fmt = NumberFormat('#,##0.00', 'th_TH');
                  ...
                  Row(
                    children: [
                      ...
                      _PRInfoChip(
                          ...
                          label:
                              '${returnDoc.items?.length ?? 0} รายการ'),
                      ...
                      Text('ยอดรวมที่คืน',
                          style: TextStyle(
                              ...
                              color: isDark
                                  ? const Color(0xFFAAAAAA)
                                  : AppTheme.textSub)),
                      Text('฿${fmt.format(returnDoc.totalAmount)}',
                          style: TextStyle(
                              fontSize: 16,
                              fontWeight: FontWeight.w700,
                              color: isDark
