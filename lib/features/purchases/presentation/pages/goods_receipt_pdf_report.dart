...
class GoodsReceiptPdfBuilder {
    ...
    return pw.Table(
      ...
      children: [
        pw.TableRow(
          ...
          children: ['#', 'เลขที่ GR', 'อ้างอิง PO',
                  'ผู้จัดจำหน่าย', 'คลังสินค้า',
                  'วันที่รับ', 'สถานะ', 'รายการ']
              .map((h) => pw.Container(
        ...
        ...receipts.asMap().entries.map((e) {
          ...
          return pw.TableRow(children: [
            ...
            cell(_date.format(r.grDate), ttfR,
                align: pw.Alignment.center, bgColor: bg),
            cell(_statusLabel(r.status), ttf,
                align: pw.Alignment.center, color: sc, bgColor: bg),
            cell('${r.items?.length ?? 0}', ttfR,
                align: pw.Alignment.center, bgColor: bg),
          ]);
        }),
      ],
  ...
  static pw.Widget _buildFooter({required pw.Font ttfR}) =>
      pw.Container(
        ...
        child: pw.Text('DEE POS — รายงานการรับสินค้า',
