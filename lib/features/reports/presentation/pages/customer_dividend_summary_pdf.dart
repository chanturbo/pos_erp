...
const _kHeaderBg = PdfColor.fromInt(0xFF00897B);
    ...
    final dataRows = rows.asMap().entries.map((entry) {
      ...
      return pw.TableRow(
        ...
        children: [
          ...
          _dCell(r.customerName, regular, fontWeight: pw.FontWeight.bold),
          _dCell('${r.orderCount}', regular, align: pw.TextAlign.center),
          _dCell(
            '฿${_money.format(r.dividendBase)}',
            regular,
          ...
          _dCell(
            _money.format(r.dividendPercent),
            regular,
            align: pw.TextAlign.center,
          ),
          _dCell(
            '฿${_money.format(r.dividendAmount)}',
            regular,
            align: pw.TextAlign.right,
            color: _kOrange,
            fontWeight: pw.FontWeight.bold,
          ...
          _dCell(
            ...
            regular,
            align: pw.TextAlign.right,
            color: r.creditAmount > 0 ? _kSub : _kSub,
          ),
          _dCell(
