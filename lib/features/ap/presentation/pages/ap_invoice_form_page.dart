...
class ApInvoiceFormPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ApInvoiceFormPage> createState() =>
      _ApInvoiceFormPageState();
}
...
class _ApInvoiceFormPageState extends ConsumerState<ApInvoiceFormPage> {
    ...
    return Column(
      ...
      children: [
        ...
        _DatePickerField(
          ...
          highlightOverdue: _dueDate != null &&
  ...
  Widget _buildItemCard(ApInvoiceItemModel item, int index, bool isDark) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border:
            Border.all(color: isDark ? Colors.white12 : AppTheme.border),
      ),
      child: Padding(
      ...
      children: [
        ...
        if (_isViewMode && widget.invoice != null) ...[
          ...
          _SummaryRow(
              label: 'จ่ายแล้ว',
              value:
                  '฿${fmt.format(widget.invoice!.paidAmount)}',
              isDark: isDark),
  ...
  Future<void> _saveInvoice() async {
    ...
    final subtotal =
        _items.fold<double>(0, (s, item) => s + item.amount);
    final total =
        subtotal + (_includeVat ? subtotal * 0.07 : 0.0);
...
class _APFormTitleBar extends StatelessWidget {
  ...
  const _APFormTitleBar(
      {required this.isEdit, required this.isView, this.status});
