...
const _kTealBg      = PdfColor.fromInt(0xFF004D40);
...
class ApPaymentPdfBuilder {
  ...
  static PdfColor _methodColor(String m) {
    switch (m) {
      case 'CASH':     return _kCash;
      case 'TRANSFER': return _kTransfer;
      case 'CHEQUE':   return _kCheque;
  ...
  static Future<pw.Document> build(
    ...
    final doc       = pw.Document(title: 'รายงานการจ่ายเงิน', author: companyName);
    ...
    final transfer = payments.where((p) => p.paymentMethod == 'TRANSFER').length;
    ...
    for (var i = 0; i < payments.length; i += rowsPerPage) {
      pages.add(payments.sublist(
          i, (i + rowsPerPage) > payments.length ? payments.length : i + rowsPerPage));
    }
    ...
    for (var pi = 0; pi < pages.length; pi++) {
      doc.addPage(pw.Page(
        ...
        build: (ctx) => pw.Column(
          ...
          children: [
            _buildHeader(
              companyName: companyName, printedAt: printedAt,
            ...
            if (pi == 0) ...[
              _buildSummaryRow(
                ...
                totalAmt: totalAmt, ttf: ttf, ttfR: ttfR,
              ),
              pw.SizedBox(height: 8),
            ],
    ...
    return pw.Container(
      ...
      child: pw.Row(
        children: [
          ...
          pw.SizedBox(width: 6),
          chip('เงินสด', cash, _kCash, _kCashBg,
              const PdfColor.fromInt(0xFFA5D6A7)),
          pw.SizedBox(width: 6),
          chip('โอนเงิน', transfer, _kTransfer, _kTransferBg,
              const PdfColor.fromInt(0xFF90CAF9)),
          pw.SizedBox(width: 6),
          chip('เช็ค', cheque, _kCheque, _kChequeBg,
          ...
          pw.Column(
            ...
            children: [
              ...
              pw.Text('฿${NumberFormat('#,##0.00').format(totalAmt)}',
                  style: pw.TextStyle(
                      font: ttf, fontSize: 12, color: _kTeal)),
            ],
          ),
        ],
      ),
    ...
    return pw.Container(
      ...
      child: pw.Row(children: [
        pw.SizedBox(width: 22, child: pw.Text('#',
            style: pw.TextStyle(font: ttf, fontSize: 9), textAlign: pw.TextAlign.center)),
  ...
  static PdfColor _methodBg(String m) {
    switch (m) {
      case 'CASH':     return _kCashBg;
      case 'TRANSFER': return _kTransferBg;
      case 'CHEQUE':   return _kChequeBg;
      default:         return _kTealLight;
    }
  }

  static pw.Widget _buildRow(ApPaymentModel p, bool isEven,
      {required pw.Font ttfR}) {
    rcell(String t,
      ...
      child: pw.Row(children: [
        ...
        pw.Expanded(
          ...
          child: pw.Container(
            ...
            child: pw.Text(methodLabel,
                style: pw.TextStyle(
                    font: ttfR, fontSize: 8, color: methodColor),
                textAlign: pw.TextAlign.center),
          ),
        ),
        pw.Expanded(
          ...
          child: pw.Text(
            ...
            style: pw.TextStyle(
                font: ttfR, fontSize: 8.5, color: _kTeal),
  ...
  static pw.Widget _buildTotalsRow({
    ...
    return pw.Container(
      ...
      child: pw.Row(
        ...
        children: [
          pw.Text('ยอดจ่ายรวมทั้งหมด  ',
              style: pw.TextStyle(font: ttf, fontSize: 10, color: _kSub)),
          pw.Text('฿${NumberFormat('#,##0.00').format(totalAmt)}',
              style: pw.TextStyle(
                  font: ttf, fontSize: 13, color: _kTeal)),
        ],
      ),
    );
  }
